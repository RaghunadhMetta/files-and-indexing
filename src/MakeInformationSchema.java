...
public class MakeInformationSchema {
	public static void main(String[] args) {
		try {
			...
			File file1 =  new File("information_schema.schemata.tbl");
			File file2 =  new File("information_schema.tables.tbl");
			File file3 =  new File("information_schema.columns.tbl");
			
			if(! file1.exists() && !file2.exists() && !file3.exists() ){
				
			
			RandomAccessFile schemataTableFile = new RandomAccessFile(file1, "rw");
			RandomAccessFile tablesTableFile = new RandomAccessFile(file2, "rw");
			RandomAccessFile columnsTableFile = new RandomAccessFile(file3, "rw");
